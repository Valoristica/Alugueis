...
-   Exemplo:
    ...
    urbana com Taxa de Ocupação $\text{TO} = 0,5$ e Coeficiente de 
    Aproveitamento $CA = 1,0$.
    - Este terreno encontra-se em zona com valor do $m2$ $q_T = 2.000,00\, \text{R\$}/m^2$
...
- Exemplo [@alonso2017, p. 4-5]:    
  - $\text{CA}_{básico} = \frac{2.100}{8.064}=0,26$  
  - Aplicou-se $\text{CA}_{Ap} = 1 – [((E – e)/E).(0,20 + (0,80.(V – v)/V))]$
  - E chegou-se a: $\text{CA}_{Ap} = 1 – [((8.064 – 2.100)/8.064) (0,20 + (0,80.(60-22)/60))] = 1 – (0,7396 . 0,7067) = 0,477$
...
-   Não faz sentido, ao nosso ver, que a variável padrão seja considerada na forma
...
- DICAS: 
  - Para uma melhor apresentação, resolva pela fórmula da Cota-Parte;
  - Elabore os cálculos em uma planilha eletrônica antes de escrevê-los no editor de textos;
  - Para verificação pode ser feito o cálculo do aluguel de cada andar em separado e depois aplicar a proporcionalidade entre a área do andar e a da unidade.
...
## Como entender o mercado imobiliário (5) {.smaller}
...
## Como entender o mercado imobiliário (6) {.smaller}
...
## Como entender o mercado imobiliário (8)
...
## Como entender o mercado imobiliário (9)
